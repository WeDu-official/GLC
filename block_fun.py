        ...
        *seventh one is optional for only data programming language run
        ...
        if someinfo == [] or someinfo is None:
            if blockinfo[0] == 'python':
                run_system_functions.run('python',1,True,f'{datatransferfile}{datatransferfileformat}')
            if blockinfo[0] == 'C':
                run_system_functions.run('C',1,True,f'{datatransferfile}{datatransferfileformat}')
            if blockinfo[0] == 'java':
                run_system_functions.run('java',1,True,f'{datatransferfile}{datatransferfileformat}')
            if blockinfo[0] == 'html':
                run_system_functions.run('html',1,True,f'{datatransferfile}{datatransferfileformat}')
            if blockinfo[0] == 'JS':
                run_system_functions.run('JS',1,True,f'{datatransferfile}{datatransferfileformat}')
            if blockinfo[0] == 'kotlin':
                run_system_functions.run('kotlin',1,True,f'{datatransferfile}{datatransferfileformat}')
            if blockinfo[0] == 'batch':
                run_system_functions.run('batch',1,True,f'{datatransferfile}{datatransferfileformat}')
